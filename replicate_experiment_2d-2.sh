...
TRAIN_PATH=data/CLEANED-SCAN/length_split/experiment2d_input_short_to_long/tasks_train.txt
DEV_PATH=data/CLEANED-SCAN/length_split/experiment2d_input_short_to_long/tasks_test.txt
EXPT_DIR=checkpoints_experiment_2d-2
ATTENTION=true
CUDA=1
