...
class Seq2Attn(nn.Module):
    """ sequence-to-attention architecture with configurable encoder and decoder.

    Args:
        encoder (EncoderRNN): object of EncoderRNN
        decoder (Seq2AttnDecoder): object of Seq2AttnDecoder
    ...
    def flatten_parameters(self):
        ...
        self.decoder.transcoder.rnn.flatten_parameters()
        self.decoder.decoder.rnn.flatten_parameters()
