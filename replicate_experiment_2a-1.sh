...
TRAIN_PATH=data/CLEANED-SCAN/length_split/experiment2a_output_short_to_long/tasks_train.txt
DEV_PATH=data/CLEANED-SCAN/length_split/experiment2a_output_short_to_long/tasks_test.txt
EXPT_DIR=checkpoints_experiment_2a-1
ATTENTION=false
CUDA=0
